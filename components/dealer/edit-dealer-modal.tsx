...
export default function EditDealerModal({
  ...
  const [formData, setFormData] = React.useState<FormState>({
    ...
    state: dealer?.state || dealer?.stateId || "",
    district: dealer?.district || dealer?.districtId || "",
    city: dealer?.city || dealer?.cityName || dealer?.cityId || "",
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      toastifyToast.success("Dealer updated successfully!");
      ...
      toastifyToast.error("Failed to update dealer. Please try again.");
    } finally {
      setLoading(false);
    }
  };
